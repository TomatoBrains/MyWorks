...
function showProfileInformation(event) {
  ...
  <p>email</p>
  <p>${allProfileInfo[click.dataset.id].email}</p>  
  <p>adress</p>
  <p>${allProfileInfo[click.dataset.id].address.city + ' ' + allProfileInfo[click.dataset.id].address.street}</p>  
  <p>phone</p>
  <p>${allProfileInfo[click.dataset.id].phone}</p>  
  <p>website</p>
