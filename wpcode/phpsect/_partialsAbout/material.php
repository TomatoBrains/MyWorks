<div class="materials">
    <div class="container">
        <div class="materials__title">
            <h2>
                Расходные материалы и косметика <span class="light">
                    для <br>
                    мастеров по шугарингу и депиляции воском
                </span>
            </h2>
        </div>
        <div class="materials__content mtxt">
    ...
    <div class="materials__leaves blur">
        <img src="<?php echo get_stylesheet_directory_uri(); ?>/img/catalog/material/leaves.png" alt="">
    </div>
</div>
