<div class="main learn-main">
    <div class="container">
        <div class="row">
            <div class="col-xl-8 col-lg-12 col-md-12 col-sm-12">
                <div class="main__descr">
                    <div class="main__descr-title">
                        <h1>Получи востребованную <br> профессию
                            <span class="light">
                                мастера шугаринга и депиляции воском
                            </span>
                            за 2 дня
                            <br>
                        </h1>
                        <p class="light roze tlism mtxt fade__content">
                            Профессиональное обучение шугарингу и депиляции воском </p>
                    </div>
                    <div class="main__descr-list fade__content">
                        <ul>
                            <li>начни зарабатывать до 2000 руб уже через 3 месяца;</li>
                    ...
                    <div class="main__descr-btn--wraper fade__content">
                        ...
                        <div class="main__descr-img">
                            <img src="<?php echo get_stylesheet_directory_uri(); ?>/img/learn/main/flower.png" alt="растение">
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-xl-5 col-lg-12 col-md-12 col-sm-12">
                <div class="main__women fade__content">
                    <img src="<?php echo get_stylesheet_directory_uri(); ?>/img/learn/main/womens.png" alt="девушка">
                </div>
            </div>
        </div>
    </div>
    <div class="main__wawe">
        ...
        <div class="main__wawe-scroll">
            <a href="#who" class="main__wawe-svg">
    ...
    <div class="learn-main__blur blur2">
        <img src="<?php echo get_stylesheet_directory_uri(); ?>/img/learn/main/blur.png" alt="">
    </div>
    <div class="learn-main__leave blur">
        <img src="<?php echo get_stylesheet_directory_uri(); ?>/img/learn/main/leave.png" alt="">
    </div>
</div>
