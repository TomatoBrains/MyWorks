...
$tms = " <br> Куда отправить - ".$_POST['soc'];
...
$mail->Subject = 'Форма с сайта  '; // Заголовок письма
 if($_POST['formname'] == 'test'){
        $mail->Body    = '
            ...
            1. В какую комнату планируете установку рольштор? ' . $qw1 . ' <br> 
            2. Какую задачу вам необходимо решить? ' . $qw2 . ' <br> 
            3. Какие рольшторы Вас интересуют ' . $qw3 . ' <br> 
            4. Выберите категорию ткани? ' . $qw4 . ' <br> 
            5. На какое количество окон необходимо? ' . $qw5 . ' <br> 
            Куда Вам отправить ' . $soc . ' <br> 
            Телефон: ' . $phone . '';
    }
    else{
